...
%
\vspace{1mm}
\noindent Spodaj podpisani Aleksander Kovač, vpisna številka 63220478, avtor zaključnega dela z naslovom:

\vspace{1mm}
\noindent\emph{Sistem za vadbo biljard igre osmica v obogateni resničnosti}\hspace{5mm}(angl. \emph{Augmented Reality Training System for Eight-Ball Pool})

\vspace{1mm}
\begin{center}IZJAVLJAM\end{center}
\begin{enumerate}
\setlength\itemsep{0mm}
\item da sem pisno zaključno delo študija izdelal samostojno pod mentorstvom izr.\ prof.\ dr.\ Matevža Peska;
...
\vspace{5mm}
\noindent V Ljubljani, dne \today \hfill Podpis študenta/-ke:
